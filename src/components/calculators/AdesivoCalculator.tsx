...
const AdesivoCalculator: React.FC<Props> = ({
  ...
  return <div className="p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold mb-2 text-slate-300">Calculadora de Adesivo</h2>
        <p className="text-slate-200">Selecione as opções desejadas e informe as dimensões.</p>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              {options.map(option => <div key={option.id} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
